 ...
 >عن الفريق
    ...
    <p className='text-right font-Changa text-[#7777] 2xl:text-[1.875rem] 
      ...
      2xl:w-[800px] lg:w-[1024px] md:w-[900px] w-full'>
        تمتلك شركة تايم تكنولوجى صفوة من الخبراء والمهندسين والفنيين يستخدمون  احدث اجهزة القياس والفحص وفك وتركيب جميع العناصر الاليكترونية بشكل احترافى والتعامل الصحيح مع الكروت Multi Layer وخبراء فى:
...
<Image src={bottel} alt="screen" className="rounded px-2 py-2 md:w-[70px] w-[80px]" />
</div>
<p className='md:font-bold md:text-2xl w-[400px] text-black'>معالجة المياة وحلولها</p>
</div>
  </li>
...
<div >
<Image src={sun} alt="screen" className="rounded px-2 py-2 md:w-[70px] w-[50px]" />
</div>
...
<div >
<Image src={macchine} alt="screen" className="rounded px-2 py-2 md:w-[70px] w-[50px]" />
</div>
...
<div className='relative '>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="887" height="868" viewBox="0 0 887 868" fill="none">
<path d="M494.795 0H887L392.205 868H0L494.795 0Z" fill="#DD3433"/>
</svg>
  </div>
  <Image src={team} alt="team" className=' relative md:w-[100%] w-[70%] z-20' />
  <div className="absolute  2xl:block hidden bottom-[-240px] left-[300px] w-full z-30">
    
  <svg xmlns="http://www.w3.org/2000/svg" width="991" height="758" viewBox="0 0 991 758" fill="none">
