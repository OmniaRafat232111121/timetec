...
const Footer = () => {
  return (
    <div className="px-0 py-10 bg-gray-100   md:px-15 mx-auto flex items-center justify-center ">
      <div
        className="grid lg:grid-cols-4 md:grid-cols-2  grid-cols-1 space-x-[200px]
     mx-auto"
      >
        <div>
        ...
        <div>
          ...
          <ul className="mt-4 text-[#777]">
            <li className="mb-2">
              <a href="">التحكم الالي</a>
            </li>
            <li className="mb-2">
              <a href="">خلايا طاقة شمسية</a>
            </li>
            <li className="mb-2">
              <a href="">تحلية الماء</a>
            </li>
            <li className="mb-2">
              <a href="">انفرتر</a>
            </li>
        ...
        <div>
          <Image
            src={log}
            alt="logo"
            className="w-[200px] mx-auto md:mt-[-20px] 
          md:mr-0 mr-[-50px] mt-[-20px]
          text-center flex items-center justify-center "
          />
          <div
            className="flex items-center justify-center space-x-1 mt-[-50px] md:mr-0 
           mr-[-50px]"
          >
