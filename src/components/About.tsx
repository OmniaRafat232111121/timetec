...
font-bold stroke  "
          ...
          <h3
            className="text-[#02AFCE]
 absolute top-[40px] right-[80px] text-4xl font-bold"
          >
            عن الشركة
          </h3>
      ...
      2xl:w-[800px] lg:w-[1024px] md:w-[900px] w-full"
          >
            تمتلك شركة تايم تكنولوجى للحلول الصناعية مركز خدمة معتمد دوليا من
            مجموعة فريكون العالمية , ومصلحة الرقابة الصناعية كجهة رسمية لإعتماد
            مراكز الصيانة الصناعية والهندسية وشركتى ABB , Schneider كما تمتلك
            صفوة من الخبراء والمهندسين والفنيين فى مجال :
          </p>
              ...
              <div className="flex items-center justify-between  md:space-x-16 space-x-[320px] ">
                <div className="">
                  <Image
                    src={screen}
                    alt="screen"
                    className="bg-blue rounded px-2 py-2"
                  />
                </div>
          ...
          <p className="text-[#777] mt-[40px] 2xl:w-[400px] w-full md:p-0 p-3">
            بإستخدام احدث اجهزة القياس والفحص وفك وتركيب جميع العناصر
            الاليكترونية بشكل احترافى والتعامل الصحيح مع الكروت Multi Layer
          </p>

          <button
            className="text-orange py-4 md:px-8 px-10 md:mt-[50px] mt-[10px] rounded-md 
  ...
  translate-x-7  transition-all ease-in-out mb-5 md:w-[200px] 
   w-[300px] flex items-center justify-center mx-auto"
          >
            اعرف المزيد
          </button>
        </div>
          ...
          <div className="relative">
            ...
            <div>
             ...
             right-[30px] bottom-[90px] w-[70px]"
              />
              <h3 className="text-white  absolute   right-[30px] bottom-[50px]">
                100 مشروع
              </h3>
            </div>
          </div>
